...
class Asana
{
    ...
    public function getWorkspaceTasks($workspaceId = null, $assignee = "me")
    {
        ...
        return $this->curl->get("tasks?opt_fields=completed,name&workspace={$workspaceId}&assignee={$assignee}");
    }
   /**
    * Returns completed tasks in the workspace
    *
    * Note: As Asana API says, you must specify an assignee when querying for workspace tasks.
    *
    * @param  string $workspaceId The id of the workspace
   ...
   /**
    ...
    public function getWorkspaceUsers($workspaceId = null)
    {
        ...
        return $this->curl->get("workspaces/{$workspaceId}/users?opt_fields=photo,name");
    }
